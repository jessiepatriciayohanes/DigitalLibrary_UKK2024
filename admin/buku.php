...
<body>
  ...
  <div class="container">
    <div class="row" style="margin-top: 1rem;">
      <div class="col">
        <h2>Data Buku</h2>
        <a href="data/tambah_buku.php" class="btn btn-success my-3"><i class="fas fa-book"></i> Tambah Buku</a>
        ...
        ?>
          <tbody>
            <tr>
              ...
              <td>
                <a href="data/detail_buku.php?idbuku=<?php echo $d['IDbuku'];?>" class="btn btn-primary text-white"><i class="fas fa-book-open"></i> Detail</a>
                <a href="data/edit_buku.php?idbuku=<?php echo $d['IDbuku'];?>" class="btn btn-warning text-white"><i class="fas fa-edit"></i> Edit</a>
                <a href="data/delete_buku.php?idbuku=<?php echo $d['IDbuku'];?>" class="btn btn-danger text-white"><i class="fas fa-trash-alt"></i> Delete</a>
              </td>
            </tr>
          </tbody>
          <?php
